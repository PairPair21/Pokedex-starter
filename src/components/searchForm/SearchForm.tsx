...
const SearchForm = () => {
    ...
    return(
        <form className="grid grid-cols-1 md:grid-cols-4 sm:grid-cols-2 gap-[20px]">
            <div>
                <label htmlFor="generation" className="block mb-2 text-mb font-medium text-white">Generation</label>
                <select {...fieldGeneration} id="generation" className='bg-[#253641] capitalize border border-gray-300 text-white 
                text-sm rounded-lg focus:ring-blue-500 focus:border-[#375EAA] block w-full p-2.5'>
            ...
            <div>
                ...
                <select {...fieldType} id="type" className='bg-[#253641] capitalize border border-gray-300 text-white 
                text-sm rounded-lg focus:ring-[#375EAA] focus:border-[#375EAA] block w-full p-2.5'>
            ...
            <div>
                ...
                <select {...fieldSort} id="sort" className='bg-[#253641] capitalize border border-gray-300 text-white 
                text-sm rounded-lg focus:ring-[#375EAA] focus:border-[#375EAA] block w-full p-2.5'>
            ...
            <div>
                ...
                {...fieldKeyword}
                id="sort" 
                className='bg-[#253641] border border-gray-300 text-white 
                text-sm rounded-lg focus:ring-[#375EAA] focus:border-[#375EAA] block w-full p-2.5'>
                </input>
            </div>
        </form>
